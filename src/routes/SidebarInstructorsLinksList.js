  ...
  render() {
    return (
      <div>
        ...
        <ListItemLink to="/lovelace-front-end/updateCohort" primary="Update Cohort" icon={<CheckIcon />} />
        <ListItemLink to="/lovelace-front-end/updateStudent" primary="Update Student" icon={<CheckIcon />} />
